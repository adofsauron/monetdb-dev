...
nohup /usr/local/bin/mserver5 \
    --dbpath=/dbfarm/SF-0_001 \
    --dbtrace=/dbfarm/logs/trace.log \
    --config=/root/.monetdb \
    --set merovingian_uri=mapi:monetdb://localhost.localdomain:50000/SF-0_001 \
    --set mapi_listenaddr=localhost \
    --set mapi_usock=/dbfarm/SF-0_001/.mapi.sock \
    --set monet_vault_key=/dbfarm/SF-0_001/.vaultkey \
